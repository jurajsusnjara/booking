...
<body>
	...
	<div id="div1" class="topmargin">
		<div id="inside1">
			<div id="objectText1">
				<a id="urlColorWhite"
					href="/opp-webapp/objekt?ime=${Objekti.get(0).getNazivObjekt()}">${Objekti.get(0).getNazivObjekt()}</a>
			</div>
		</div>
	</div>
	...
	<div id="div2" class="topmargin">
		<div id="inside2">
			<div id="objectText1">
				<a id="urlColorWhite"
					href="/opp-webapp/objekt=${Objekti.get(1).getNazivObjekt()}">${Objekti.get(1).getNazivObjekt()}</a>
			</div>
		</div>
	</div>
	...
	<div id="div3">
		<div id="inside3">
			<div id="objectText1">
				<a id="urlColorWhite"
					href="/opp-webapp/objekt?ime=${Objekti.get(2).getNazivObjekt()}">${Objekti.get(2).getNazivObjekt()}</a>
			</div>
		</div>
	</div>
	...
	<div id="div4">
		<div id="inside4">
			<div id="objectText1">
				<a id="urlColorWhite"
					href="/opp-webapp/objekt?ime=${Objekti.get(3).getNazivObjekt()}">${Objekti.get(3).getNazivObjekt()}</a>
			</div>
		</div>
	</div>
