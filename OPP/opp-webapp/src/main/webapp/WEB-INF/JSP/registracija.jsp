...
<link rel='stylesheet'
	href='/opp-webapp/webjars/bootstrap/3.3.5/css/bootstrap.min.css'>
...
<body>
	...
	<div id="left" class="topmargin">
		...
		<div id="loginbox"
			class="topmargin mainbox col-md-8  col-sm-8 col-sm-offset-2">
				...
				<div class="panel-body">
					...
					<form id="loginform" class="form-horizontal" role="form"
						...
						<div class="input-group">
							...
							<input id="login-password" type="text" class="form-control"
								name="korisnickoIme" placeholder="Unesite svoj email" required>
						</div>
						<br> <label>Lozinka:</label>
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-lock"></i></span>
							<input id="login-password" type="password" class="form-control"
								name="sifra" placeholder="Unesite Lozinku" required>
						</div>
						<br>
						<div class="input-group col-xs-12 text-center login-action">
							<label>
								<button id="login" type="submit" name="method" value="login"
									class="btn btn-success">Prijavi se</button> <!-- <span id="btn-login"><a href="#" class="btn btn-primary" value="login">Prijavi se</a></span> -->
							</label>
						</div>
				</div>
	...
	<div id="right" class="topmargin">
		...
		<div id="loginbox"
			class="topmargin mainbox col-md-9 col-sm-8 col-sm-offset-2">
			<div class="panel white-alpha-90">
				<div class="panel-heading">
					<div class="panel-title text-center">
						<h2>Registracija</h2>
					...
					<form id="loginform" class="form-horizontal" role="form"
						...
						<div class="input-group">
							...
							<input id="login-username" type="text" class="form-control"
								name="Ime" value="" placeholder="Unesite ime" required>
						...
						<br> <label>Prezime:</label>
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-lock"></i></span>
							<input id="login-password" type="text" class="form-control"
								name="Prezime" placeholder="Unesite prezime" required>
						</div>
						<br> <label>Telefonski broj:</label>
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-lock"></i></span>
							<input id="login-password" type="text" class="form-control"
								name="Telefon" placeholder="Unesite broj telefona" required>
						</div>
						<br> <label>Email adresa:</label>
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-lock"></i></span>
							<input id="login-password" type="text" class="form-control"
								name="Email" placeholder="Unesite email" required>
						</div>
						<label></label>
						<div class="input-group">
							<span class="input-group"><i class="fa fa-lock"></i></span>
							<h3>
								<b>Podaci o prebivalistu</b>
							</h3>
							<hr>
						</div>
						...
						<div class="input-group">
							...
							<input id="login-password" type="text" class="form-control"
								name="Adresa"
								placeholder="Unesite adresu (ulica i postanski broj)" required>
						</div>
						<br>
						<label>Grad:</label>
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-lock"></i></span>
							<input id="login-password" type="text" class="form-control"
								name="Grad" placeholder="Unesite ime grada" required>
						</div>
						...
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-lock"></i></span>
							<input id="login-password" type="text" class="form-control"
								name="PostanskiBroj" placeholder="Unesite postanski broj"
								required>
						</div>
						<br> <br>
						<div class="input-group">
						...
						<div class="input-group col-xs-12 text-center login-action">
							<label> <!-- <span id="btn-login"><a href="#" class="btn btn-primary">Registriraj se</a></span> -->
								<button id="register" type="submit" name="method"
									value="register" class="btn btn-success">Registriraj
									se</button>
						...
						<c:if test="${greska == null}">
								...
								<script type="text/javascript">
								alert("Provjerite e-mail s dodatnim uputama za registraciju. Hvala");
								</script>
						</c:if>
				</div>
				<div style="margin-top: 10px" class="form-group">
