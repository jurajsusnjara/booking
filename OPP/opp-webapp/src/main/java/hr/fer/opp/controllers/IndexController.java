...
public class IndexController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// svi objekti u paketu hr.fer.opp.model imaju defaultni konstruktor bez
		// argumenata,
		// nakon inicijalizacije objekta, preko settera se postave SVE potrebne
		// vrijednosti
		// OSIM id-a kojeg æe baza sama automatski generirat, jedino se kod
		// objekta Korisnik
...
//		 DAOProvider.getDAO().putAdresa(adresa);
		...
		// DAOProvider.getDAO().getReservationsFor(korisnici.get(0));
